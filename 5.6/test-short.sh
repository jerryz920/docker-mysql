...
ABAC_ID=${ABAC_ID:-"10.10.1.36:MYSQL"}
ABAC_PID=${ABAC_PID:-"152.3.145.138:4144"}
ABAC_PORT=${ABAC_PORT:-7777}
ABAC_HOST=${ABAC_HOST:-10.10.1.9}

curl http://10.10.1.9:7777/postObjectAcl -d "{ \"principal\": \"10.10.1.36:1987\",  \"otherValues\": [\"10.10.1.36:MYSQL\", \"https://github.com/jerryz920/mysql\"] }"
